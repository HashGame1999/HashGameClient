...
import { GameAccount, MasterAccount, SettingAccount } from '../lib/RippleConst';
...
- 1.0 defines the version of game rules, more game setting detail will be published by **SettingAccount**(**${SettingAccount}**).
...
## Promotional Plans
### Shareholder Plan: 
Any XRP holder who send 10000 XRP to **MasterAccount**(**${MasterAccount}**) before XRP Ledger#99000001 becomes our shareholder, participate in annual dividends.
